...
export default function Admin() {
  ...
  try {
    await axios.put(`https://community-website-aitsp.onrender.com/admin/approve/${id}`);
    const res = await axios.get("https://community-website-aitsp.onrender.com/admin/posts");
    setPosts(res.data);
    alert("Post approved!");
  } catch (err) {
    console.log(err);
...
const deletePost = async (id) => {
  try {
    await axios.delete(`https://community-website-aitsp.onrender.com/admin/post/${id}`);
    const res = await axios.get("https://community-website-aitsp.onrender.com/admin/posts");
    setPosts(res.data);
    alert("Post deleted!");
  } catch (err) {
...
const suspendUser = async (id) => {
  try {
    await axios.put(`https://community-website-aitsp.onrender.com/admin/suspend/${id}`);
    const res = await axios.get("https://community-website-aitsp.onrender.com/admin/users");
    setUsers(res.data);
...
const deleteUser = async (id) => {
  try {
    await axios.delete(`https://community-website-aitsp.onrender.com/admin/user/${id}`);
    const res = await axios.get("https://community-website-aitsp.onrender.com/admin/users");
    setUsers(res.data);
    alert("User deleted!");
  } catch (err) {
